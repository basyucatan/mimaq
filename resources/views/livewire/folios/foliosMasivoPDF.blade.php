...
<head>
    ...
    <style>
        ...
        .salto-pagina:last-child { page-break-after: avoid; }
    </style>
</head>
<body>
    @foreach($coleccionFolios as $item)
        @php
            $folio = $item['folio'];
            $materialesAgrupados = $item['materialesAgrupados'];
        @endphp
                ...
                <div class="contenedor-principal">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 20%; border: none;" class="centro">
                                                @if(!empty($folio->Estilo?->foto))
                                                    <img src="{{ public_path('storage/estilos/' . $folio->Estilo->foto) }}" style="max-width: 100%; max-height: 60px;">
                                                @endif
                                            </td>
                                        </tr>
                                    </table>
                    ...
                    <div class="columna-derecha">
                        ...
                        <table class="cuadro-borde">
                            <tbody>
                                <tr>
                                    <td style="width: 40%;" class="gris negrita">PESO ORO</td>
                                    <td style="width: 60%;" class="centro negrita"></td>
                                </tr>
                                <tr>
                            ...
                            <tr>
                                <td style="width: 48%; vertical-align: top; border: none; padding: 0 8px 0 0;">
                                    <table style="width: 100%; border-collapse: collapse; margin-bottom: 8px;">
                                        <tr>
                                            <td class="centro negrita" style="width: 24px; border: 0.5pt solid #000; border-bottom: none;">A</td>
                                            <td style="border-bottom: 0.5pt solid #000;"></td>
                                        </tr>
                                    </table>
                                    <table style="width: 100%; border-collapse: collapse; margin-bottom: 14px;">
                                        <tr><td style="height: 14px; border-bottom: 0.5pt solid #000;"></td></tr>
                                        <tr><td style="height: 14px; border-bottom: 0.5pt solid #000;"></td></tr>
                                    </table>
                                    <table style="width: 100%; border-collapse: collapse; margin-bottom: 8px;">
                                        <tr>
                                            <td class="centro negrita" style="width: 24px; border: 0.5pt solid #000; border-bottom: none;">B</td>
                                            <td style="border-bottom: 0.5pt solid #000;"></td>
                                        </tr>
                                    </table>
                                ...
                                <td style="width: 48%; vertical-align: top; border: none; padding: 0 0 0 8px;">
                                    <table style="width: 100%; border-collapse: collapse; margin-bottom: 8px;">
                                        <tr>
                                            <td class="centro negrita" style="width: 24px; border: 0.5pt solid #000; border-bottom: none;">C</td>
                                            <td style="border-bottom: 0.5pt solid #000;"></td>
                                        </tr>
                                    </table>
                                    <table style="width: 100%; border-collapse: collapse;">
