                        ...
                        <form gy-2>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input wire:model="castingIni" type="text" class="inpBase"
                                        onfocus="this.select()">
                                    @error('castingIni')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input wire:model="castingFin" type="text" class="inpBase"
                                        onfocus="this.select()">
                                    @error('castingFin')
                                        <span class="error text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input wire:model="diamantesG" type="text" class="inpBase"
                                        onfocus="this.select()">
                                    @error('diamantesG')
                                        <span class="error text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="col-md-3 d-flex align-items-center justify-content-center">
                                    <div class="form-check form-switch shadow-sm p-2 rounded border"
                                        style="background-color: #f8f9fa; min-width: 150px;">
                                        <input wire:model.live="enBoveda" class="form-check-input ms-0" type="checkbox"
                                            role="switch" id="switchEstatus"
                                            style="cursor: pointer; width: 2.5em; height: 1.25em;">
                                        <label class="form-check-label fw-bold mb-0 ms-2" for="switchEstatus"
                                ...
                                <div class="col-md-3 d-flex align-items-center justify-content-center">
                                    <div class="form-check form-switch shadow-sm p-2 rounded border"
                                        style="background-color: #f8f9fa; min-width: 150px;">
                                        <input wire:model.live="habilitada" class="form-check-input ms-0"
                                            type="checkbox" role="switch" id="switchEstatus"
                                            style="cursor: pointer; width: 2.5em; height: 1.25em;">
                                        <label class="form-check-label fw-bold mb-0 ms-2" for="switchEstatus"
                                            style="cursor: pointer; font-size: 0.9rem;">
...
@if ($verModalDividir)
    <div class="modal fade show d-block" tabindex="-1" style="background-color: rgba(0,0,0,0.5);">
        <div x-data="{}" x-init="dragModal($el)" class="modal-dialog modal-dialog-centered"
            wire:ignore.self>
                ...
                <div class="cardPrin">
                    ...
                    <div class="cardPrin-body p-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="inpBase bg-light text-center fw-bold"
                                value="{{ $cantidad }}" disabled>
                        </div>
                        <div class="mb-3">
                            <label class="etiBase">Piezas para la Nueva Bandeja</label>
                            <input type="number" wire:model.defer="piezasADividir" class="inpBase text-center"
                                min="1" max="{{ $cantidad - 1 }}">
                            @error('piezasADividir')
                    ...
                    <div class="cardPrin-footer d-flex justify-content-end gap-2">
                        ...
                        <button type="button" wire:click="procesarDivision" class="bot botAzul botChico">Confirmar
                            División</button>
                    </div>
                </div>
            </div>
        ...
        <div x-data="{}" x-init="dragModal($el)" class="modal-dialog modal-dialog-centered"
            ...
            <div class="modal-content border-0 bg-transparent">
                <div class="cardPrin">
                        ...
                        <div class="mb-3">
                            ...
                            <select wire:model.defer="IdBandejaDestino" class="inpBase">
                                ...
                                @foreach ($bandejasCompatibles as $b)
                                    <option value="{{ $b->id }}">
                                        ID: {{ $b->id }} | {{ $b->cantidad }} pzs | Casting F:
                                        {{ $b->castingFinal }}g
                                    </option>
                                @endforeach
                            </select>
                            @error('IdBandejaDestino')
                                <span class="text-danger small">{{ $message }}</span>
                            @enderror
                        </div>
                    </div>
                    <div class="cardPrin-footer d-flex justify-content-end gap-2">
                        <button type="button" wire:click="cancel" class="bot botNegro botChico">Cancelar</button>
                        <button type="button" wire:click="procesarUnion" class="bot botVerde botChico">Confirmar
                            Fusión</button>
                    </div>
                </div>
            </div>
                ...
                <div class="cardPrin">
                    <div class="cardPrin-header d-flex justify-content-between align-items-center"
                        ...
                        <button type="button" class="btn-close btn-close-white"
                            wire:click="cerrarModalTraspaso()"></button>
                    </div>
                    <div class="cardPrin-body p-3">
                        <div class="row g-3">
                            <div class="col-md-6">
                    ...
                    <div class="cardPrin-footer d-flex justify-content-end gap-2">
                        <button type="button" class="bot botNegro botChico"
                            wire:click="cerrarModalTraspaso()">Cancelar</button>
                        <button type="button" class="bot botVerde botChico" wire:click="guardarTraspaso()">Confirmar
                            Traspaso</button>
                    </div>
                </div>
            </div>
...
@if ($verModalHistorial)
    <div class="modal fade show d-block" tabindex="-1" style="background: rgba(0,0,0,0.5);">
        <div x-data="{}" x-init="dragModal($el)" class="modal-dialog modal-xl modal-dialog-centered"
            wire:ignore.self>
            <div class="modal-content border-0 bg-transparent">
                <div class="cardPrin">
                    <div class="cardPrin-header" style="cursor: move;">
