    ...
    <div class="cardSec">
        <div class="cardSec-header">
            <div class="d-flex align-items-center gap-2">
                ...
                <span>Trazabilidad de Inventario</span>
            </div>
            ...
            <div class="d-flex gap-2">
                ...
                <div class="position-relative">
                    <input type="text" wire:model.live="buscar" class="inpSolo" placeholder="Buscar movimiento..." style="width: 200px;">
                </div>
            </div>
        </div>
...
<td>
    ...
    @if($mov->glosa)
        <div class="text-muted x-small italic text-truncate" style="max-width: 250px;">{{ $mov->glosa }}</div>
    @endif

    {{-- Cambiamos la validación para que mire a la Referencia --}}
    ...
    @endif
        ...
        <div class="card-footer bg-white border-0 py-2">
            <div class="d-flex justify-content-between align-items-center">
                <div class="small text-muted">Registros: {{ $this->movimientos->total() }}</div>
