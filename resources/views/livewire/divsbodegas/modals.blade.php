            ...
            <div class="modal-content">
                <div class="cardPrin" style="cursor: move;">
                    <div class="cardPrin-header d-flex justify-content-between align-items-center">
                        <h5 class="m-0">
                            {{ $selected_id ? 'Editar Divsbodega' : 'Crear Divsbodega' }}
                        </h5>
                    ...
                    <div class="cardPrin-body" style="padding: 0 20px; max-height: 400px; overflow-y: auto;">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label for="bodega" class="etiBase">Bodega</label>
                                    <input wire:model="bodega" type="text" class="inpBase" id="bodega">@error('bodega') <span class="error text-danger">{{ $message }}</span> @enderror
                                </div>
</div></form>
                    </div>
