...
{    
    public function run()
    {
        ...
        User::create(['name'=>'Director','email'=>'director@gmail.com','telefono'=>'9991001001',
            'password'=>Hash::make('claudio#'),'activo'=>true,'IdDepto'=>9])->assignRole('Director');
        User::create(['name'=>'Adriana','email'=>'adriana@gmail.com','telefono'=>'9991001002',
            'password'=>Hash::make('adriana1234'),'activo'=>true,'IdDepto'=>9])->assignRole('Admin');
    }
}
