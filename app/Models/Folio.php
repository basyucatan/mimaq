...
class Folio extends Model
{
    ...
    public function bandejas(){return $this->hasMany('App\Models\Bandeja', 'IdFolio', 'id');}
    ...
    public function getTieneMatsAttribute(){return $this->foliosmats()->exists();}
    public function lote(){return $this->hasOne('App\Models\Lote', 'id', 'IdLote');}
